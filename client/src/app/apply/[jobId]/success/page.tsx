...
const SuccessPage = async ({ params: { jobId } }: Props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-indigo-50 to-white-100">
      ...
      <p className="text-2xl text-emerald-700 mb-4">Thank you for applying.</p>
      <h1 className="text-2xl text-emerald-700 mb-4">{`You have succesfully applied to ${job.position}`}</h1>
      <Link href="/">
